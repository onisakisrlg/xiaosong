...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative pt-28 pb-16 lg:pt-36 lg:pb-24 bg-slate-950 overflow-hidden">
      {/* Decorative patterns */}
      <div className="absolute top-0 right-0 w-3/4 h-3/4 bg-radial-gradient from-white/5 via-transparent to-transparent opacity-60 pointer-events-none rounded-full blur-3xl z-0" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <div className="inline-flex items-center space-x-2 bg-slate-900 border border-slate-700 px-3.5 py-1 rounded-full text-slate-300 text-xs font-semibold uppercase tracking-wider">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <a
                href="#products"
                className="inline-flex items-center justify-center space-x-2 px-6 py-3.5 rounded-lg bg-white text-sm font-bold tracking-wide text-slate-950 hover:bg-slate-200 shadow-xl shadow-white/5 transition-all text-center cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 relative mt-8 lg:mt-0">
            ...
            {/* Outer elements */}
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-white/5 rounded-xl -z-10 animate-pulse" />
