...
export const TIRE_PRODUCTS: TireProduct[] = [
  {
    ...
    speedRating: 'H',
    priceYen: 25000,
    features: ['極上の静粛性と乗り心地', '優れた低燃費性能', 'ウェット制動性能の向上'],
    description: '濡れた路面での安心感が長く続く、 環境にも配慮したプレミアムコンフォートタイヤ',
    image: 'michelin_primacy',
    popularity: 4.9,
    specDetails: {
      productCode: '626074',
      information: 'プレミアムタッチ適用外',
      sectionWidth: 228,
      outerDiameter: 702,
      measuringRimWidth: 6.5,
      compatibleRimWidth: '6-8',
      lowNoise: true,
      lowFuelEco: true,
      reviewScore: 4.78,
      reviewCount: 264
    ...
    galleryImages: [
      'https://i.postimg.cc/j5hDkR2Z/4w-1595-3528700650686-tire-michelin-primacy-5-245-slash-45-r.webp',
      'https://i.postimg.cc/yYxDv4Hv/4w-1595-3528700650686-tire-michelin-primacy-5-245-slash-45-r.webp',
      'https://i.postimg.cc/SNPJPTSw/4w-1595-3528700650686-tire-michelin-primacy-5-245-slash-45-r.webp',
      'https://i.postimg.cc/k5QGB7xf/4w-1595-3528700650686-tire-michelin-primacy-5-245-slash-45-r.webp',
      'https://i.postimg.cc/DZ5zP5Yk/4w-1595-3528700650686-tire-michelin-primacy-5-245-slash-45-r.webp',
      'https://i.postimg.cc/brBNKrh1/4w-1595-3528700650686-tire-michelin-primacy-5-245-slash-45-r.webp'
    ]
  },
  {
    id: 'bridgestone-regno-grx3-rv',
    brand: 'BRIDGESTONE',
    name: 'REGNO GR-XⅢ TYPE RV',
    type: TireType.COMFORT,
    width: 225,
    aspectRatio: 60,
    diameter: 17,
    ...
    popularity: 4.95,
    specDetails: {
      productCode: 'BS-REGNO-GRX3-RV',
      information: 'ミニバン・SUV専用設計',
      sectionWidth: 225,
      outerDiameter: 702,
      measuringRimWidth: 6.5,
      compatibleRimWidth: '6-8',
  ...
  },
  {
    ...
    description: 'ラグジュアリーセダンおよびスポーツ走行に最適。非対称トレッドデザインが高速コーナリングでの剛性を高め、特殊シリカ配合により濡れた路面での制動距离を大幅に短縮します。',
    image: 'sport',
    popularity: 4.9,
  },
  {
  ...
  },
  {
    ...
    description: 'エコロジーかつ経済的な選択。ナノシリカコンパウンドが発熱を抑えて転がり抵抗を低健。耐久性に優れた深い溝設計で、走れば走るほど燃料費を節約します。',
    image: 'eco',
    popularity: 4.7,
  },
  {
...
const JAPANESE_TRANSLATION = {
  ...
  // Products
  productTitle: 'おすすめプレミアムタイヤ',
  productSub: 'ミシュランやブリヂストンをはじめ、世界性能基準をクリアしたプレミアム正規品タイヤの卸売・小売りに対応。お見積り・お取り寄せもスムーズです。',
  sport: 'スポーツタイヤ',
  comfort: 'コンフォートタイヤ',
  eco: 'エコ・低燃費タイヤ',
  suv: 'SUV用・オフロード',
